...
## 3) Los datos de la siguiente tabla pertenecen a las calificaciones finales en matemática evaluadas de 0 a 10 de 134 alumnos de tres cursos de 3º de Secundaria. Creemos que, mediante el test de Kolmogorov-Smirnov, pueden admitir como modelo una distribución normal N(5’5,1).
...
## 4) Los datos de la siguiente tabla pertenecen a la producción en toneladas por Ha de remolacha tras utilizar tres tipos de fertilizantes. Queremos analizar si existen diferencias significativas entre los diferentes tratamientos, mediante el test de Kruskal-Wallis. Las hectáreas fueron dispuestas al azar:
...
## Como nota personal: Wilcoxon sirve para observar para UNA VARIABLE si hay cambios o no en la media; Wilcoxon Mann-Whitney sirve para comparar dos variables y estudiar si son medias son iguales o cambian; Kolmogorov Smirnov sirve para UNA VARIABLE y demuestra si es verdad o falso suponer que tiene un x mediana y una y desviación estándar; Kruskall-Wallis es una evolución de chi cuadrado, funciona con 2 o más variables, y permite ver la dominancia de alguna de ellas (si la media es distinta para una variable en particular)
